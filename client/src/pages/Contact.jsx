    ...
    <div className="min-h-screen pt-24 pb-16 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
            Contact Us
          </motion.h1>
          <motion.p variants={fadeUp} className="text-gray-500 max-w-lg mx-auto">
            Have a question, need a quote, or want to schedule a pickup? We're here to help.
          </motion.p>
        </motion.div>
