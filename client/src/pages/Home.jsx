          ...
          >
            ...
            <div className="relative">
              <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto">
                ...
                <div className="mt-6">
                  <a href="https://instagram.com/_.straightway_couriers._" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/60 hover:text-white transition-colors text-sm">
